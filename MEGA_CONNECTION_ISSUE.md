...
> Примечание: учетные данные удалены из файла. Немедленно смените пароль MEGA и обновите MEGA_EMAIL/MEGA_PASSWORD в .env и GitHub Secrets.
...
2. Попробуйте войти с вашим email и паролем (значения из MEGA_EMAIL/MEGA_PASSWORD)
